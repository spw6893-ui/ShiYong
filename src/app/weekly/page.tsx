...
export default function WeeklyPage() {
  ...
  return <main><SiteHeader /><div className="inner-shell">
    <ArticleShell title={latest.title} summary={latest.summary} eyebrow={`每周总结 · ${latest.issue}`} readingTime={latest.readingTime} publishedAt={latest.publishedAt} sources={latest.sources} content={latest.content} backHref="/" backLabel="返回首页" />
